...
CATLOGO = "https://telegra.ph/file/65669ca2fa2063b48d49e.jpg"
...
async def inline_handler(event):  
    ...
    if query_user_id == Config.OWNER_ID or query_user_id in Config.SUDO_USERS:
        ...
        if query.startswith("**iqthonbot"):
            buttons = [
                (
                    ...
                    Button.url("الريبو", "https://github.com/SflapJack/Assistant"),
                )
            ]
            ...
            buttons = [
                Button.inline(text="إظهار الخيارات.", data="show_pmpermit_options"),
            ]
        ...
        buttons = [
            (
                Button.url("Source code", "https://github.com/SflapJack/Assistant"),
                Button.url(
                    "Deploy",
                    "https://dashboard.heroku.com/new?button-url=https://github.com/SflapJack/Assistant",
                ),
            )
        ]
        markup = event.client.build_reply_markup(buttons)
        ...
        result = types.InputBotInlineResult(
            ...
            url="https://dashboard.heroku.com/new?template=https://github.com/SflapJack/Assistant",
            thumb=photo,
            content=photo,
            send_message=types.InputBotInlineMessageMediaAuto(
                reply_markup=markup, message=text, entities=msg_entities
