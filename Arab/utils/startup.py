...
LOGS = logging.getLogger("فلاب ثون العرب \n ")
...
async def verifyLoggerGroup():
    ...
    if BOTLOG:
        ...
        iqphoto1 = await iqthon.upload_file(file="SQL/extras/flap1.jpg")
        _, groupid = await create_supergroup(            "تخزين فلاب ثون العرب العام", iqthon, Config.TG_BOT_USERNAME, descript  ,  iqphoto1 )
    ...
    if PM_LOGGER_GROUP_ID != -100:
        ...
        iqphoto2 = await iqthon.upload_file(file="SQL/extras/flap2.jpg")
        _, groupid = await create_supergroup(            "تخزين فلاب ثون العرب الخاص", iqthon, Config.TG_BOT_USERNAME, descript    , iqphoto2  )
