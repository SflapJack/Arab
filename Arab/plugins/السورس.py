...
async def iq(iqthonevent):
    ...
    ALIVE_TEXT = gvarstatus("ALIVE_TEXT") or "𝗐𝖾𝗅𝖼𝗈𝗆𝖾 FalpThon 𝖺𝗅 𝖺𝗋𝖺𝖻 𓃠"
    IQTHON_IMG = gvarstatus("ALIVE_PIC") or "https://telegra.ph/file/b322c03af4db9952a31d9.mp4"
...
async def amireallyalive(event):
    ...
    IQTHON_ALIVE_TEXT = "❬ Flap-Thon - العرب ، 🕸  ❭ :"
...
async def _(event):
    ...
    OUTPUT = (f"♛︙  وحـدة المعلومات الخاصه بتنصيبك مع جميع الفارات  لتنصيب سورس فلاب ثون @iqthon :**\n\n{o}")
...
async def _(event):
    ...
    await asyncio.sleep(1)
    await edit_or_reply(event , "حسنا جاري تحديث فلاب ثون العرب انتضر من 5 الى 10 دقائق")
    try:
...
https://t.me/RRRRRRR6RR/36
  • لتغير صوره او فيديو امر الفحص اضغط هنا ↶
https://t.me/RRRRRRR6RR/39
  • لتغير كليشة امر حماية الخاص اضغط هنا ↶
https://t.me/RRRRRRR6RR/35
  • لوضع صوره او فيديو حماية الخاص اضغط هنا ↶
https://t.me/RRRRRRR6RR/38
  • لتغير عدد تحذيرات حماية الخاص اضغط هنا ↶
https://t.me/RRRRRRR6RR/45
  • لتغير نبذه الوقتيه اضغط هنا ↶
https://t.me/RRRRRRR6RR/54
  • لتغير صوره وقتيه اضغط هنا ↶
 https://t.me/RRRRRRR6RR/46 
  • لتغير خط زخرفه اسم وقتي اضغط هنا ↶
 https://t.me/RRRRRRR6RR/59
  •  لوضع ايموجي بجانب اسم وقتي اضغط هنا ↶
 https://t.me/RRRRRRR6RR/37
• لتغير امر من الاوامر اضغط هنا ↶
https://t.me/RRRRRRR6RR/4718
• لكيفيه حذف الفار اضغط هنا ↶
https://t.me/RRRRRRR6RR/51

قناة الكلايش  : @RRRRRRR6RR
قناه شروحات الاوامر  : @RRRRRRR6RR
قناه المتغيرات او الفارات : @RRRRRRR6RR""")
    ...
    if vname in vlist:
        ...
        if cmd == "اضف":
            if not vinfo and vname == "ALIVE_TEMPLATE":
                return await edit_delete(event, f"**♛︙  📑 يرجى متابع قناه الفارات تجدها هنا : @RRRRRRR6RR")
...
♛  اوامر الملصقات ↢ ( .م16 )
———————×———————
شرح الأوامر : ( @RRRRRRR6RR ) .
قناه السورس : ( @RRRRRRR6RR ) .
...
( .ايقاف اسم وقتي )
———————×———————
 ♛︙ يوجد شرح مفصل عن الامر هنا : https://t.me/RRRRRRR6RR/4484
""")
...
الشرح :   يضيفلك جميع الاعضاء الي برابط الكروب يضيفهم بكروبك 
 ———————×———————
يوجد شرح بتفصيل هنا : https://t.me/RRRRRRR6RR/4483
شرح الأوامر : ( @RRRRRRR6RR ) .
قناه السورس : ( @RRRRRRR6RR ) .
جميع الاوامر تكون بدايتها نقطة .
""")
...
———————×———————
يوجد شرح مفصل للتكرار هنا : https://t.me/RRRRRRR6RR/4704 
قناه السورس : ( @RRRRRRR6RR ) .
جميع الاوامر تكون بدايتها نقطة .
""")
...
✐ :  يعطيك رموز للزخرفه2 
———————×———————
يوجد شرح مفصل عن اوامر زخرفه هنا : https://t.me/RRRRRRR6RR/4705
""")
...
———————×———————
  ⦑   شرح اوامر الوسائط هنا :  https://t.me/RRRRRRR6RR/4721  ⦒
""")
...
———————×———————
  ⦑   شرح اوامر الملصقات هنا  :  https://t.me/RRRRRRR6RR/4720  ⦒
""")
...
———————×——————— 
الأمر ⦙ ( .المده )
الشرح  : يضهر لك مدة تشغيل بوت فلاب ثون لديك 
———————×———————
الأمر ⦙ ( .تحميل ملف + الرد ع الملف )
الشرح : يحمل ملفات فلاب ثون 
———————×———————
الأمر ⦙ ( .مسح ملف + الرد ع الملف )
الشرح :  يمسح الملف الي حملته  
———————×———————
الأمر ⦙ ( .تحديث )
الشرح :  امر لأعاده التشغيل وتحديث ملفات السورس وتسريع الفلاب ثون 
———————×———————
الأمر ⦙ ( .اطفاء مؤقت + عدد الثواني )
الشرح : يقوم بأطفاء الفلاب ثون بعدد الثواني الي ضفتها  عندما تخلص الثواني سيتم اعاده تشغيل الفلاب ثون 
———————×———————
الأمر ⦙ ( .الاوامر ) 
...
———————×———————
الأمر ⦙ ( .استخدامي )
الشرح :   يضهر لك كمية استخدامك لفلاب ثون
———————×———————
الأمر ⦙ ( .تاريخ التنصيب )
...
الشرح : اي شخص يعملك تاك او يراسلك او يرد عليك يرد عليه فلاب ثون بكليشة انا حاليا غير موجود ويضع له السبب الي نتة وضعته
———×———
...
@check_owner
async def inlineiqthon(iqthon):
    text = "**♛︙ قـائمـه الاوامـر :**\n**♛︙ قنـاه السـورس :** @RRRRRRR6RR\n**♛︙ شـرح اوامـر السـورس : @RRRRRRR6RR**\n**♛︙ شـرح فـارات السـورس : @RRRRRRR6RR** "
